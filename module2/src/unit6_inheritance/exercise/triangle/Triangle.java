...
public class Triangle extends Shape {
    ...
    public double getArea() {
        return Math.pow(getPerimeter() * (getPerimeter() - side1) *
                (getPerimeter() - side2) * (getPerimeter() - side3), 0.2);
    }
    @Override
    public String toString() {
        return "Triangle{" +
                ...
                ", side2=" + side2 +
                ", side3=" + side3 +
                '}' + super.toString() + " the perimeter of triengle is"
                +getPerimeter() + "the area of triengle is" +getArea();
    }
}
